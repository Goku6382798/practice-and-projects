...
from controller.language_controller import translate_message, translate_dict
        ...
        if login_type == "1" and mobile:
            ...
            if result.get('mpin') == mpin:
                ...
                if isprofilesetup is True:
                    ...
                    user_details_mapped = master_mapping(user_details)
                    print("4")
                    user_details_mapped["name"] = translate_message(user_details_mapped.get("name"), languageCode)
                    ...
                    user_details_mapped["communicationaddress"] = translate_dict(result.get('communicationaddress', communicationaddress), languageCode),
                    user_details_mapped["address"] = translate_dict(result.get('address', address), languageCode),
                    print(user_details_mapped, "user")
                    try:
                        user_details_mapped['address'] = user_details_mapped['address'][0]
                        user_details_mapped['communicationaddress'] = user_details_mapped['communicationaddress'][0]
                    except:
                        pass
                    print(user_details_mapped, "user")
                    ...
                    print(1)
                    empty_details = empty_mapping()
                    empty_details["name"] = translate_message(empty_details.get("name"), languageCode)
                    empty_details['userid'] = user_id
                    empty_details['mobile'] = mobile
                    ...
                    communicationaddress, address = blank_address()
                    empty_details["communicationaddress"] = translate_dict(result.get('communicationaddress', communicationaddress), languageCode),
                    try:
                        empty_details['address'] = empty_details['address'][0]
                        empty_details['communicationaddress'] = empty_details['communicationaddress'][0]
                    except:
                        pass
                    empty_details["address"] = translate_dict(result.get('address', address), languageCode),
