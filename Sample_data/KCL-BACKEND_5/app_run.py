...
from features.basic_details_verification import basic_details_bp
from features.edityourprofile import edit_your_profile_bp
from features.communication_address import communication_bp
from features.aadhar import aadhar_bp
from features.video_api import video_bp
...
app.register_blueprint(basic_details_bp)
app.register_blueprint(edit_your_profile_bp)
app.register_blueprint(communication_bp)
app.register_blueprint(aadhar_bp)
