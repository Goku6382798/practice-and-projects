...
public class CustomerRevenueService {
    ...
    public void process(StreamsBuilder streamsBuilder) {
        ...
        KStream<Integer, Integer> customerOrderRevStream = customerProductOrders.map((k, v) -> {
            ...
            return new KeyValue<Integer, Integer>(v.getCustomerId(), orderRevenue);
        });
        ...
        KTable<Integer, Integer> customerRevenueTable = customerOrderGroups.reduce((aggValue, customerOrderRev) -> aggValue + customerOrderRev);
