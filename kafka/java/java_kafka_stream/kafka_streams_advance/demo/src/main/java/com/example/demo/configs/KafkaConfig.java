...
public class KafkaConfig {
    ...
    String orderCreatedTopicCleanupPolicy;
    ...
    public KafkaAdmin.NewTopics orderDataTopics() {
        return new KafkaAdmin.NewTopics(
            TopicBuilder.name(customersTopic)
                ...
                .configs(Map.of(
                    TopicConfig.RETENTION_MS_CONFIG, String.valueOf(defaultRetention),
            ...
            TopicBuilder.name(orderCreatedTopic)
                ...
                .configs(Map.of(
                    TopicConfig.RETENTION_MS_CONFIG, String.valueOf(defaultRetention),
                    TopicConfig.CLEANUP_POLICY_CONFIG, orderCreatedTopicCleanupPolicy
                )).build()
        );
    }
    ...
    @Bean
    public ProducerFactory<Integer, Products> productProducerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }
    ...
    @Bean
    public KafkaTemplate<Integer, Products> productKafkaTemplate() {
