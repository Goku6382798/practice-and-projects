...
consumed_logs = []
BATCH_SIZE = 1000
LOG_DIR = '/home/gautam/practice/kafka_heavy_workflow/products_logs'
FILE_PREFIX = "products_logs_batch"
...
def make_consumer():
    ...
    avro_deserilizer = AvroDeserializer(
        schema_registry_client=schema_reg_client,
        schema_str=PRODUCTS_SCHEMA,
        from_dict=lambda data, ctx: products(**data)
    )
    ...
    return DeserializingConsumer({
        ...
        "value.deserializer": avro_deserilizer,
        "auto.offset.reset": "earliest",
    })

def consume_messages():
    consumer = make_consumer()
    consumer.subscribe(["ecommerce.products-value"])
    try:
        while True:
