...
from schemas import ORDER_ITEMS_SCHEMA
...
consumed_logs = []
BATCH_SIZE = 1000
LOG_DIR = '/home/gautam/practice/kafka_heavy_workflow/order_items_logs'
FILE_PREFIX = "order_items_logs_batch"
...
def make_consumer():
    ...
    avro_deserializer = AvroDeserializer(
        ...
        schema_str=ORDER_ITEMS_SCHEMA,
        from_dict=lambda data, ctx: order_items(**data)
    )
...
def consume_messages():
    ...
    consumer.subscribe(["ecommerce.order_items-value"])
    try:
        while True:
