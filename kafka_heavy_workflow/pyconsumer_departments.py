...
from schemas import DEPARTMENTS_SCHEMA
...
consumed_logs = []
BATCH_SIZE = 1000
LOG_DIR = '/home/gautam/practice/kafka_heavy_workflow/departments_logs'
FILE_PREFIX = "departments_logs_batch"
...
def make_consumer():
    ...
    avro_deserializer = AvroDeserializer(
        ...
        schema_str=DEPARTMENTS_SCHEMA,
        from_dict=lambda data, ctx: departments(**data)
    )
...
def consume_messages():
    ...
    consumer.subscribe(["ecommerce.departments-value"])
    try:
        while True:
